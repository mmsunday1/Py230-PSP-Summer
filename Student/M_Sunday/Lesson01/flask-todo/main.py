...
app.secret_key = b'\x9d\xb1u\x08%\xe0\xd0p\x9bEL\xf8JC\xa3\xf4J(hAh\xa4\xcdw' \
                 b'\x12S*,u\xec\xb8\xb8'
...
def login():
    if request.method == 'POST':
        ...
        return render_template('login.jinja2', error="Incorrect username or "
                                                    "password")
    else:
